...
export const Leetcode = (props) => {
  return (
    ...
    >
      <path
        fill={props.fill || "#FFA116"} // Default LeetCode color
        d="M4.19 16.627L1.465 13.9a.5.5 0 010-.707l9.899-9.9a.5.5 0 01.707 0l3.99 3.99a.5.5 0 010 .707l-3.182 3.18a.5.5 0 000 .708l2.123 2.121a.5.5 0 00.707 0l4.243-4.242a.5.5 0 01.707 0l2.828 2.83a.5.5 0 010 .707L15.22 22.234a.5.5 0 01-.708 0l-2.121-2.121a.5.5 0 010-.707l4.243-4.243a.5.5 0 000-.707l-2.122-2.122a.5.5 0 00-.707 0l-3.182 3.182a.5.5 0 01-.707 0l-3.99-3.99a.5.5 0 010-.707l2.122-2.121a.5.5 0 00.707 0l1.414 1.414a.5.5 0 010 .707L6.611 14.506a.5.5 0 000 .707l1.415 1.415a.5.5 0 010 .707l-2.122 2.121a.5.5 0 01-.707 0z"
      />
    </svg>
  );
};
